...
// pdf chart 
Vue.component('chart-bar', require('./components/ChartBar.vue'));
Vue.component('chart-radar', require('./components/ChartRadar'));
Vue.component('chart-radarmbti', require('./components/ChartRadarMbti'));
Vue.component('chart-scatter', require('./components/Scatter'));
