...
<div class="inner-block">
	...
	<div class="float-left text-left">
		<a href="/create-stu" class="btn btn-success">ایجاد دانش آموز</a>
	</div>
		...
		<table v-if="all_stu.length && !stu_id" class="table table-striped table-bordered table-hover table-condensed col-md-12 saeid_block">
			...
			<tbody>
				<tr v-for="stu in all_stu">
					...
					<td v-else-if="stu.base_id == 5">هشتم</td>
					<td v-else-if="stu.base_id == 0">نهم</td>
					<td v-else-if="stu.base_id == 1">دهم</td>
					<td v-else-if="stu.base_id == 2">یازدهم</td>
					<td v-else-if="stu.base_id == 3">دوازدهم</td>
					<td v-else-if="!stu.base_id"> </td>

					<td v-if="stu.r_id === 0">ریاضی فیزیک</td>
					<td v-else-if="stu.r_id === 1">تجربی</td>
					<td v-else-if="stu.r_id === 2">انسانی</td>
					<td v-else-if="!stu.r_id">عمومی</td>
					<td v-if="stu.img"><a :href="'http://185.141.212.155/'+stu.img"><img width="70" height="70" :src="'http://185.141.212.155/'+stu.img" alt=""></a></td>
					<td v-if="!stu.img" > </td>
					<td>@{{stu.rest}}</td>
